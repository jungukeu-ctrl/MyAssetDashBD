...
| # | 작업 | 파일 | 비고 |
|---|------|------|------|
| PS-DECUM-Phase4 | 인출시작 나이 최소값(55) validation, 목표 월 인출액(`withdrawal.monthlyTarget`)·국민연금 개시나이·IRP2 수령개시나이 사용자 입력 필드 추가 | `js/pension/ps-withdrawal-ui.js` | Phase1~5(Phase4 제외)는 2026-07-03 완료. 우선순위 낮음(작업지시서 원문 기준) |
