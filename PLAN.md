...
| ISA-INVEST | ISA 거래내역 적용 시 `invest[9]`에 누적 투자금 저장 — Pension-tracer ISA 납입 델타 자동계산 연동 | `modal.js` | 2026-03-20 |

---

## 5. 남은 작업 목록

> **현재 남은 작업 없음** — Phase 1 + 버그픽스 + 개인연금저축 카드 통합 + ISA/RIA 차트 추가 + ISA 납입 자동계산 완료.
